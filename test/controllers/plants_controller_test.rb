...
class PlantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plant" do
    assert_difference('Plant.count') do
      post plants_url, params: { plant: { numDeepWell: @plant.numDeepWell, pID: @plant.pID, plantName: @plant.plantName } }
    end
  ...
  test "should update plant" do
    patch plant_url(@plant), params: { plant: { numDeepWell: @plant.numDeepWell, pID: @plant.pID, plantName: @plant.plantName } }
